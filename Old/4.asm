...
section .text
global main
extern io_print_string, io_newline, io_get_dec, Sleep@4, io_get_char ;deklaracje funkcji
...
exit:
    push 1000 ;czas trwania czekania
    call Sleep@4 ;czekaj i wyświetlaj wynik
